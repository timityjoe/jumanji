...
from jumanji.environments.routing.tarware.utils import compute_action_mask
from jumanji.environments.routing.tarware.utils_spawn import (
...
class Generator(abc.ABC):
    ...
    def __init__(
        ...
        """Initializes a tarware generator, used to generate grids for
...
class GeneratorBase(Generator):
    ...
    def __init__(
        ...
        """Initializes a tarware generator."""
        super().__init__(
            shelf_rows,
            shelf_columns,
            column_height,
...
class RandomGenerator(GeneratorBase):
    ...
    def __init__(
        ...
        """Initialises an tarware generator, used to generate grids for
        the RobotWarehouse environment."""
        super().__init__(
            shelf_rows,
            shelf_columns,
