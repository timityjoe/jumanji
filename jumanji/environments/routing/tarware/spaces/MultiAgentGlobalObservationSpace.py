...
from jumanji.environments.routing.tarware.definitions import Action, AgentType, CollisionLayers
from jumanji.environments.routing.tarware.spaces.MultiAgentBaseObservationSpace import (
