...
from jumanji.environments.routing.tarware.constants import _AGENTS, _SHELVES
from jumanji.environments.routing.tarware.types import Action, Agent, Position
from jumanji.environments.routing.tarware.utils_shelf import (
